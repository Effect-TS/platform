...
/** @internal */
export const TypeId: App.TypeId = Symbol.for(
  "@effect/platform/Http/App"
) as App.TypeId
...
/** @internal */
export const isHttpApp = (
  u: unknown
): u is App.HttpApp<unknown, unknown, unknown, unknown> => typeof u === "function" && TypeId in u
...
export const makeDefault: <R, E>(
  ...
  ) => Effect.Effect<R, E, ServerResponse.ServerResponse>
...
export const map = dual<
  <A, In, B>(
    f: (a: A, request: In) => B
  ) => <R, E>(self: App.HttpApp<R, E, In, A>) => App.HttpApp<R, E, In, B>,
  <R, E, In, A, B>(
    self: App.HttpApp<R, E, In, A>,
    f: (a: A, request: In) => B
...
export const mapRequest = dual<
  <In, In2>(
    f: (request: In2) => In
  ) => <R, E, A>(self: App.HttpApp<R, E, In, A>) => App.HttpApp<R, E, In2, A>,
  <R, E, In, A, In2>(
    self: App.HttpApp<R, E, In, A>,
    f: (request: In2) => In
